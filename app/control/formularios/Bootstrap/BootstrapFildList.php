<?php
class BootstrapFildList extends TPage
{
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Formulário bootstrap lista de campos');
        ...
        $combo->enableSearch();
        $combo->addItems(['a'=> 'Opção A', 'b'=> 'Opção B','c'=> 'Opção C']);
        $combo->setSize('100%');
        $texto->setSize('100%');
        ...
        $fieldlist->addField('<b>Numero</b>', $numero, ['width' => '25%','sum' => true]);
