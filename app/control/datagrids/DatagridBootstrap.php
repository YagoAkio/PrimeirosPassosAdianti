...
class DatagridBootstrap extends TPage
{
    ...
    public function __construct(){
        ...
        $col_id -> title = 'Clique nessa coluna para ação';
        ...
        $this->datagrid->addAction($action1, 'Vizualizar', 'fa:search blue');
        $this->datagrid->addAction($action2, 'Deletar', 'fa:trash red');
