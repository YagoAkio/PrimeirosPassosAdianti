...
class FormularioSelecoesBanco extends TPage
{
    public function __construct()
    {
        ...
        $radio2   = new TDBRadioGroup('radio2','curso','Categoria','id','nome');
        $check    = new TDBCheckGroup('check','curso','Categoria','id','nome');
        $check2   = new TDBCheckGroup('check2','curso','Categoria','id','nome');
        ...
        $autocomp = new TDBEntry('autocomplete','curso','Categoria','id');
